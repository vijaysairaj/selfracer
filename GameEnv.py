...
class RacingEnv:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("VSR CAR")
        self.screen.fill((0,0,0))
        self.back_image = pygame.image.load("Track1.png").convert()
    ...
    def render(self, action):
        ...
        # score
        text_surface = self.font.render(f'Points {self.car.points}', True, pygame.Color('RED'))
        self.screen.blit(text_surface, dest=(0, 0))
        # speed
        text_surface = self.font.render(f'Speed {self.car.vel*-1}', True, pygame.Color('RED'))
